...
var question = new _vue2.default({
  el: '#question',
  data: function data() {
    return {
      state: {},
  ...
  methods: {
    answer: function answer(e) {
      ...
      _store2.default.updateAnswer(answer);
      _store2.default.updateIsShowQuestion(false);
      _store2.default.updateIsShowJudge(true);
      _store2.default.updateIsShowResult(false);
    }
  },
  computed: {
...
var judge = new _vue2.default({
  el: '#judge',
  data: function data() {
    return {
      state: {
        descriptions: ['全ての始まりの場所にして不死者の使命の終の地、『最初の火の炉』の中枢部にてプレイヤーを待ち受ける光の大王グウィンの成れの果て。', '深淵歩き（大嘘）', '棄てられた都アノール・ロンドにて「処刑者」スモウと共に聖堂を守る「竜狩り」の騎士。']
      },
      sharedState: _store2.default.state
    };
  },
  ...
  methods: {
    next: function next() {
      _store2.default.nextIndex();
      _store2.default.updateIsShowQuestion(true);
      _store2.default.updateIsShowJudge(false);
      _store2.default.updateIsShowResult(false);
    }
  },
  computed: {
